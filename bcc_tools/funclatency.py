...
#                    [-F] [-r] [-l LEVEL] [-v] [-z TASKNAME] pattern
#
# Examples:
...
#     ./funclatency -i 2 -d 10 c:open # output every 2s, for duration 10s
#     ./funclatency -p 181 vfs_read   # time process 181 only
#     ./funclatency 'vfs_fstat*'      # time both vfs_fstat() and vfs_fstatat()
#     ./funclatency -l 3 do_sys_open  # track nested calls up to depth 3
#
...
parser.add_argument("-u", "--microseconds", action="store_true", help="microsecond histogram")
parser.add_argument("-m", "--milliseconds", action="store_true", help="millisecond histogram")
parser.add_argument("-F", "--function", action="store_true",
                    help="show a separate histogram per function")
parser.add_argument("-r", "--regexp", action="store_true",
                    help="use regular expressions. Default is '*' wildcards only.")
parser.add_argument("-l", "--level", type=int, help="set the level of nested or recursive functions")
